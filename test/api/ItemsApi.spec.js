...
(function(root, factory) {
  ...
  describe('ItemsApi', function() {
    ...
    describe('getCollectionRole', function() {
      it('should call getCollectionRole successfully', function(done) {
        //uncomment below and update the code to test getCollectionRole
        //instance.getCollectionRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('grantCollectionRole', function() {
      it('should call grantCollectionRole successfully', function(done) {
        //uncomment below and update the code to test grantCollectionRole
        //instance.grantCollectionRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('revokeCollectionRole', function() {
      it('should call revokeCollectionRole successfully', function(done) {
        //uncomment below and update the code to test revokeCollectionRole
        //instance.revokeCollectionRole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
