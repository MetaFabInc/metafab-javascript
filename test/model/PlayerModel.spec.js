...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.PlayerModel();
  });
  ...
  describe('PlayerModel', function() {
    it('should create an instance of PlayerModel', function() {
      // uncomment below and update the code to test PlayerModel
      //var instance = new MetafabJavascript.PlayerModel();
      //expect(instance).to.be.a(MetafabJavascript.PlayerModel);
    });
