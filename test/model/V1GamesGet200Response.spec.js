...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaFabApi.V1GamesGet200Response();
  });
  ...
  describe('V1GamesGet200Response', function() {
    it('should create an instance of V1GamesGet200Response', function() {
      // uncomment below and update the code to test V1GamesGet200Response
      //var instance = new MetaFabApi.V1GamesGet200Response();
      //expect(instance).to.be.a(MetaFabApi.V1GamesGet200Response);
    });
