...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaFabApi.V1CurrenciesGet200ResponseAllOfContract();
  });
  ...
  describe('V1CurrenciesGet200ResponseAllOfContract', function() {
    it('should create an instance of V1CurrenciesGet200ResponseAllOfContract', function() {
      // uncomment below and update the code to test V1CurrenciesGet200ResponseAllOfContract
      //var instance = new MetaFabApi.V1CurrenciesGet200ResponseAllOfContract();
      //expect(instance).to.be.a(MetaFabApi.V1CurrenciesGet200ResponseAllOfContract);
    });
