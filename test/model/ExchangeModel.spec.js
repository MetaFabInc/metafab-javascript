...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.ExchangeModel();
  });
  ...
  describe('ExchangeModel', function() {
    it('should create an instance of ExchangeModel', function() {
      // uncomment below and update the code to test ExchangeModel
      //var instance = new MetafabJavascript.ExchangeModel();
      //expect(instance).to.be.a(MetafabJavascript.ExchangeModel);
    });
