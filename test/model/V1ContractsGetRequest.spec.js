...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaFabApi.V1ContractsGetRequest();
  });
  ...
  describe('V1ContractsGetRequest', function() {
    it('should create an instance of V1ContractsGetRequest', function() {
      // uncomment below and update the code to test V1ContractsGetRequest
      //var instance = new MetaFabApi.V1ContractsGetRequest();
      //expect(instance).to.be.a(MetaFabApi.V1ContractsGetRequest);
    });
