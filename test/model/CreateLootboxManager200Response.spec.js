...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CreateLootboxManager200Response();
  });
  ...
  describe('CreateLootboxManager200Response', function() {
    it('should create an instance of CreateLootboxManager200Response', function() {
      // uncomment below and update the code to test CreateLootboxManager200Response
      //var instance = new MetafabJavascript.CreateLootboxManager200Response();
      //expect(instance).to.be.a(MetafabJavascript.CreateLootboxManager200Response);
    });
