...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.GetCurrencies200ResponseInner();
  });
  ...
  describe('GetCurrencies200ResponseInner', function() {
    it('should create an instance of GetCurrencies200ResponseInner', function() {
      // uncomment below and update the code to test GetCurrencies200ResponseInner
      //var instance = new MetafabJavascript.GetCurrencies200ResponseInner();
      //expect(instance).to.be.a(MetafabJavascript.GetCurrencies200ResponseInner);
    });
