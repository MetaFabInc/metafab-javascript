...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CollectionModel();
  });
  ...
  describe('CollectionModel', function() {
    it('should create an instance of CollectionModel', function() {
      ...
      //var instance = new MetafabJavascript.CollectionModel();
      //expect(instance).to.be.a(MetafabJavascript.CollectionModel);
    });
