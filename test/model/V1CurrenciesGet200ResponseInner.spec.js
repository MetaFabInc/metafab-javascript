...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaFabApi.V1CurrenciesGet200ResponseInner();
  });
  ...
  describe('V1CurrenciesGet200ResponseInner', function() {
    it('should create an instance of V1CurrenciesGet200ResponseInner', function() {
      // uncomment below and update the code to test V1CurrenciesGet200ResponseInner
      //var instance = new MetaFabApi.V1CurrenciesGet200ResponseInner();
      //expect(instance).to.be.a(MetaFabApi.V1CurrenciesGet200ResponseInner);
    });
