...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.LootboxManagerModel();
  });
  ...
  describe('LootboxManagerModel', function() {
    it('should create an instance of LootboxManagerModel', function() {
      // uncomment below and update the code to test LootboxManagerModel
      //var instance = new MetafabJavascript.LootboxManagerModel();
      //expect(instance).to.be.a(MetafabJavascript.LootboxManagerModel);
    });
