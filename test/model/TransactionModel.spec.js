...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.TransactionModel();
  });
  ...
  describe('TransactionModel', function() {
    it('should create an instance of TransactionModel', function() {
      ...
      //var instance = new MetafabJavascript.TransactionModel();
      //expect(instance).to.be.a(MetafabJavascript.TransactionModel);
    });
