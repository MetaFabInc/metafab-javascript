...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.PublicPlayer();
  });
  ...
  describe('PublicPlayer', function() {
    it('should create an instance of PublicPlayer', function() {
      // uncomment below and update the code to test PublicPlayer
      //var instance = new MetafabJavascript.PublicPlayer();
      //expect(instance).to.be.a(MetafabJavascript.PublicPlayer);
    });
