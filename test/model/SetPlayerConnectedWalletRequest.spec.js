...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.SetPlayerConnectedWalletRequest();
  });
  ...
  describe('SetPlayerConnectedWalletRequest', function() {
    it('should create an instance of SetPlayerConnectedWalletRequest', function() {
      // uncomment below and update the code to test SetPlayerConnectedWalletRequest
      //var instance = new MetafabJavascript.SetPlayerConnectedWalletRequest();
      //expect(instance).to.be.a(MetafabJavascript.SetPlayerConnectedWalletRequest);
    });
