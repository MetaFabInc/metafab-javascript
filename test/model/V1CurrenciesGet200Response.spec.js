...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaFabApi.V1CurrenciesGet200Response();
  });
  ...
  describe('V1CurrenciesGet200Response', function() {
    it('should create an instance of V1CurrenciesGet200Response', function() {
      // uncomment below and update the code to test V1CurrenciesGet200Response
      //var instance = new MetaFabApi.V1CurrenciesGet200Response();
      //expect(instance).to.be.a(MetaFabApi.V1CurrenciesGet200Response);
    });
