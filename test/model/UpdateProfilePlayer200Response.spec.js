...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.UpdateProfilePlayer200Response();
  });
  ...
  describe('UpdateProfilePlayer200Response', function() {
    it('should create an instance of UpdateProfilePlayer200Response', function() {
      // uncomment below and update the code to test UpdateProfilePlayer200Response
      //var instance = new MetafabJavascript.UpdateProfilePlayer200Response();
      //expect(instance).to.be.a(MetafabJavascript.UpdateProfilePlayer200Response);
    });
