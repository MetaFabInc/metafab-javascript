...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CreateCollection200ResponseAllOfContract();
  });
  ...
  describe('CreateCollection200ResponseAllOfContract', function() {
    it('should create an instance of CreateCollection200ResponseAllOfContract', function() {
      // uncomment below and update the code to test CreateCollection200ResponseAllOfContract
      //var instance = new MetafabJavascript.CreateCollection200ResponseAllOfContract();
      //expect(instance).to.be.a(MetafabJavascript.CreateCollection200ResponseAllOfContract);
    });
