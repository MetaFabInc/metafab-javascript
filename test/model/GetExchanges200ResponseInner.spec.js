...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.GetExchanges200ResponseInner();
  });
  ...
  describe('GetExchanges200ResponseInner', function() {
    it('should create an instance of GetExchanges200ResponseInner', function() {
      // uncomment below and update the code to test GetExchanges200ResponseInner
      //var instance = new MetafabJavascript.GetExchanges200ResponseInner();
      //expect(instance).to.be.a(MetafabJavascript.GetExchanges200ResponseInner);
    });
