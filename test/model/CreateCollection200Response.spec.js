...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CreateCollection200Response();
  });
  ...
  describe('CreateCollection200Response', function() {
    it('should create an instance of CreateCollection200Response', function() {
      // uncomment below and update the code to test CreateCollection200Response
      //var instance = new MetafabJavascript.CreateCollection200Response();
      //expect(instance).to.be.a(MetafabJavascript.CreateCollection200Response);
    });
