...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.RemovePlayerConnectedWalletRequest();
  });
  ...
  describe('RemovePlayerConnectedWalletRequest', function() {
    it('should create an instance of RemovePlayerConnectedWalletRequest', function() {
      // uncomment below and update the code to test RemovePlayerConnectedWalletRequest
      //var instance = new MetafabJavascript.RemovePlayerConnectedWalletRequest();
      //expect(instance).to.be.a(MetafabJavascript.RemovePlayerConnectedWalletRequest);
    });
