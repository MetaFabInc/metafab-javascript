...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CreateCollectionRequest();
  });
  ...
  describe('CreateCollectionRequest', function() {
    it('should create an instance of CreateCollectionRequest', function() {
      ...
      //var instance = new MetafabJavascript.CreateCollectionRequest();
      //expect(instance).to.be.a(MetafabJavascript.CreateCollectionRequest);
    });
