...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.GetLootboxManagers200ResponseInner();
  });
  ...
  describe('GetLootboxManagers200ResponseInner', function() {
    it('should create an instance of GetLootboxManagers200ResponseInner', function() {
      // uncomment below and update the code to test GetLootboxManagers200ResponseInner
      //var instance = new MetafabJavascript.GetLootboxManagers200ResponseInner();
      //expect(instance).to.be.a(MetafabJavascript.GetLootboxManagers200ResponseInner);
    });
