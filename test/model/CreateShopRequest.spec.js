...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CreateShopRequest();
  });
  ...
  describe('CreateShopRequest', function() {
    it('should create an instance of CreateShopRequest', function() {
      ...
      //var instance = new MetafabJavascript.CreateShopRequest();
      //expect(instance).to.be.a(MetafabJavascript.CreateShopRequest);
    });
