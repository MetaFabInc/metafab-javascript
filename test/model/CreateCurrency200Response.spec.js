...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetafabJavascript.CreateCurrency200Response();
  });
  ...
  describe('CreateCurrency200Response', function() {
    it('should create an instance of CreateCurrency200Response', function() {
      // uncomment below and update the code to test CreateCurrency200Response
      //var instance = new MetafabJavascript.CreateCurrency200Response();
      //expect(instance).to.be.a(MetafabJavascript.CreateCurrency200Response);
    });
