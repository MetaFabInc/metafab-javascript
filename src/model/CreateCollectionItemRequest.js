...
class CreateCollectionItemRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCollectionItemRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCollectionItemRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCollectionItemRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['attributes']) { // data not null
            ...
            for (const item of data['attributes']) {
                CreateCollectionItemRequestAttributesInner.validateJsonObject(item);
            };
        }
...
CreateCollectionItemRequest.RequiredProperties = ["id", "name", "description"];
