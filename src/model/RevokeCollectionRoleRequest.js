...
class RevokeCollectionRoleRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>RevokeCollectionRoleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevokeCollectionRoleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RevokeCollectionRoleRequest.RequiredProperties) {
            if (!data[property]) {
...
RevokeCollectionRoleRequest.RequiredProperties = ["role"];
