...
import CreateCollectionItemRequestAttributesInnerValue from './CreateCollectionItemRequestAttributesInnerValue';
...
class CreateCollectionItemRequestAttributesInner {
     ...
     * @param value {module:model/CreateCollectionItemRequestAttributesInnerValue} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = CreateCollectionItemRequestAttributesInnerValue.constructFromObject(data['value']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/CreateCollectionItemRequestAttributesInnerValue} value
 */
