...
class SetShopOfferRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>SetShopOfferRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetShopOfferRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetShopOfferRequest.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['inputCollectionAddress'] && !(typeof data['inputCollectionAddress'] === 'string' || data['inputCollectionAddress'] instanceof String)) {
            throw new Error("Expected the field `inputCollectionAddress` to be a primitive type in the JSON string but got " + data['inputCollectionAddress']);
        }
        // ensure the json data is a string
        if (data['inputCollectionId'] && !(typeof data['inputCollectionId'] === 'string' || data['inputCollectionId'] instanceof String)) {
            throw new Error("Expected the field `inputCollectionId` to be a primitive type in the JSON string but got " + data['inputCollectionId']);
        }
        ...
        // ensure the json data is a string
        if (data['inputCurrencyAddress'] && !(typeof data['inputCurrencyAddress'] === 'string' || data['inputCurrencyAddress'] instanceof String)) {
            throw new Error("Expected the field `inputCurrencyAddress` to be a primitive type in the JSON string but got " + data['inputCurrencyAddress']);
        }
        // ensure the json data is a string
        if (data['inputCurrencyId'] && !(typeof data['inputCurrencyId'] === 'string' || data['inputCurrencyId'] instanceof String)) {
            throw new Error("Expected the field `inputCurrencyId` to be a primitive type in the JSON string but got " + data['inputCurrencyId']);
        }
        // ensure the json data is a string
        if (data['outputCollectionAddress'] && !(typeof data['outputCollectionAddress'] === 'string' || data['outputCollectionAddress'] instanceof String)) {
            throw new Error("Expected the field `outputCollectionAddress` to be a primitive type in the JSON string but got " + data['outputCollectionAddress']);
        }
        // ensure the json data is a string
        if (data['outputCollectionId'] && !(typeof data['outputCollectionId'] === 'string' || data['outputCollectionId'] instanceof String)) {
            throw new Error("Expected the field `outputCollectionId` to be a primitive type in the JSON string but got " + data['outputCollectionId']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is a string
        if (data['outputCurrencyAddress'] && !(typeof data['outputCurrencyAddress'] === 'string' || data['outputCurrencyAddress'] instanceof String)) {
            throw new Error("Expected the field `outputCurrencyAddress` to be a primitive type in the JSON string but got " + data['outputCurrencyAddress']);
        }
        // ensure the json data is a string
        if (data['outputCurrencyId'] && !(typeof data['outputCurrencyId'] === 'string' || data['outputCurrencyId'] instanceof String)) {
            throw new Error("Expected the field `outputCurrencyId` to be a primitive type in the JSON string but got " + data['outputCurrencyId']);
        }
...
SetShopOfferRequest.RequiredProperties = ["id"];
