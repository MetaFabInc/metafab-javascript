...
export default class ShopsApi {
    ...
    */
     ...
     */
    createShopWithHttpInfo(xAuthorization, xPassword, createShopRequest) {
      ...
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling createShop");
      }
     ...
     */
    createShop(xAuthorization, xPassword, createShopRequest) {
      return this.createShopWithHttpInfo(xAuthorization, xPassword, createShopRequest)
     ...
     * @param {String} shopId Any shop id within the MetaFab ecosystem.
    ...
    getShopOfferWithHttpInfo(shopId, shopOfferId) {
      ...
      return this.apiClient.callApi(
        '/v1/shops/{shopId}/items/{shopOfferId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    removeShopOfferWithHttpInfo(shopId, shopOfferId, xAuthorization, xPassword) {
      let postBody = null;
      // verify the required parameter 'shopId' is set
      if (shopId === undefined || shopId === null) {
      ...
      // verify the required parameter 'xPassword' is set
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling removeShopOffer");
      }
     ...
     */
    removeShopOffer(shopId, shopOfferId, xAuthorization, xPassword) {
      return this.removeShopOfferWithHttpInfo(shopId, shopOfferId, xAuthorization, xPassword)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransactionModel} and HTTP response
     */
    setShopOfferWithHttpInfo(shopId, xAuthorization, xPassword, setShopOfferRequest) {
      ...
      // verify the required parameter 'xPassword' is set
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling setShopOffer");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransactionModel}
     */
    setShopOffer(shopId, xAuthorization, xPassword, setShopOfferRequest) {
      return this.setShopOfferWithHttpInfo(shopId, xAuthorization, xPassword, setShopOfferRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransactionModel} and HTTP response
     */
    useShopOfferWithHttpInfo(shopId, shopOfferId, xAuthorization, xPassword) {
      let postBody = null;
      // verify the required parameter 'shopId' is set
      if (shopId === undefined || shopId === null) {
      ...
      // verify the required parameter 'xPassword' is set
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling useShopOffer");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransactionModel}
     */
    useShopOffer(shopId, shopOfferId, xAuthorization, xPassword) {
      return this.useShopOfferWithHttpInfo(shopId, shopOfferId, xAuthorization, xPassword)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransactionModel} and HTTP response
     */
    withdrawFromShopWithHttpInfo(shopId, xAuthorization, xPassword, withdrawFromShopRequest) {
      ...
      // verify the required parameter 'xPassword' is set
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling withdrawFromShop");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransactionModel}
     */
    withdrawFromShop(shopId, xAuthorization, xPassword, withdrawFromShopRequest) {
      return this.withdrawFromShopWithHttpInfo(shopId, xAuthorization, xPassword, withdrawFromShopRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
