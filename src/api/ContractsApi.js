...
export default class ContractsApi {
    ...
    */
     ...
     */
    transferContractOwnershipWithHttpInfo(contractId, xAuthorization, xPassword, transferContractOwnershipRequest) {
      ...
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling transferContractOwnership");
      }
     ...
     */
    transferContractOwnership(contractId, xAuthorization, xPassword, transferContractOwnershipRequest) {
      return this.transferContractOwnershipWithHttpInfo(contractId, xAuthorization, xPassword, transferContractOwnershipRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TransactionModel} and HTTP response
     */
    upgradeContractTrustedForwarderWithHttpInfo(contractId, xAuthorization, xPassword, upgradeContractTrustedForwarderRequest) {
      ...
      // verify the required parameter 'xPassword' is set
      if (xPassword === undefined || xPassword === null) {
        throw new Error("Missing the required parameter 'xPassword' when calling upgradeContractTrustedForwarder");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TransactionModel}
     */
    upgradeContractTrustedForwarder(contractId, xAuthorization, xPassword, upgradeContractTrustedForwarderRequest) {
      return this.upgradeContractTrustedForwarderWithHttpInfo(contractId, xAuthorization, xPassword, upgradeContractTrustedForwarderRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
