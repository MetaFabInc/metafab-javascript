...
export default class GamesApi {
    ...
    */
     ...
     */
    getGame(gameId) {
      return this.getGameWithHttpInfo(gameId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} gameId The game id of the authenticating game.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UpdateGame200Response} and HTTP response
     */
    updateGameWithHttpInfo(gameId, xAuthorization, updateGameRequest) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = UpdateGame200Response;
      return this.apiClient.callApi(
     ...
     * @param {String} xAuthorization The `secretKey` of the authenticating game.
     * @param {module:model/UpdateGameRequest} updateGameRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UpdateGame200Response}
     */
